...
import SidebarSections from '../../sidebar/sidebarSections/sidebarSections';
import { AccordionButton } from './mobileProductsStyles';
  ...
  return (
    <div>
      <AccordionButton initial={false} onClick={() => setExpanded(!isOpen)}>
        <NavbarSectionLink>Products</NavbarSectionLink>
        <motion.div
          animate={{
            rotate: isOpen ? 180 : 0,
          }}
